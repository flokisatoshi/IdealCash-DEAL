    ...
    nWeight(0)
{
    ...
    frameBlocks->setStyleSheet("QFrame { background: none; margin-bottom: 5px; }");
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a idealcash address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About idealcash"), this);
    aboutAction->setToolTip(tr("Show information about idealcash"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for idealcash"));
...
void BitcoinGUI::createToolBars()
{
    ...
    //header1->setMinimumSize(200, 150);
    //header1->setSizePolicy(QSizePolicy::Fixed, QSizePolicy::Fixed);
    //header1->setStyleSheet("QLabel { background-color: #e09900; }");
    header1->setPixmap(QPixmap(":/images/header"));

	toolbar->addWidget(header1);
    ...
    //footer->setMinimumSize(150, 50);
    //footer->setSizePolicy(QSizePolicy::Fixed, QSizePolicy::Fixed);
    //footer->setStyleSheet("QWidget { background-color: #1e2024; background-repeat: no-repeat; background-image: url(:/images/footer); }");
    //footer1->setStyleSheet("QLabel { background-color: #1e2024; }");
    footer1->setPixmap(QPixmap(":/images/footer"));
	toolbar->addWidget(footer1);
//#e09900
//#1e2024
    //toolbar->addWidget(TBarSpacer1());
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("idealcash client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("idealcash client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to idealcash network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid idealcash address or malformed URI parameters."));
    }
