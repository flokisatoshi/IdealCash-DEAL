...
bool parseBitcoinURI(const QUrl &uri, SendCoinsRecipient *out)
{
    ...
    if(uri.scheme() != QString("idealcash"))
        return false;
...
{
    // Convert idealcash:// to idealcash:
    //
    //    Cannot handle this later, because bitcoin:// will cause Qt to see the part after // as host,
    //    which will lower-case it (and thus invalidate the address).
    if(uri.startsWith("idealcash://"))
    {
        uri.replace(0, 12, "idealcash:");
    }
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "idealcash.lnk";
}
...
{
    return GetAutostartDir() / "idealcash.desktop";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("idealcash-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  idealcash-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    setWindowTitle(tr("idealcash-Qt"));
...
//gold color code  #e09900
//black color code #000000
//dark grey code #1e2024
// #969675
void SetBlackThemeQSS(QApplication& app)
{
    app.setStyleSheet("QWidget        { background: rgb(41,44,48); }"
                      ...
                      //menu bar on top
                      "QMenuBar       { background: #1e2024; color: rgb(110,116,126); }"
                      "QMenu          { background: rgb(30,32,36); color: rgb(222,222,222); }"
                      "QMenuBar::item { background-color: #1e2024; color: rgb(222,222,222);}"
                      "QMenu::item:selected { background-color: rgb(135,146,160); }"
                      "QMenuBar::item:selected { background-color: rgb(41,44,48); }"
                      "QLabel         { background-color:transparent; color: rgb(120,127,139); }"
                      ...
                      //toolbar button on left
                      "QToolButton    { background: #1e2024; color: rgb(116,122,134); border: none; border-left-color: rgb(30,32,36); border-left-style: solid; border-left-width: 6px; margin-top: 8px; margin-bottom: 8px; }"
                      "QToolButton:checked { color: rgb(255,255,255); border: none; border-left-color: #e09900; border-left-style: solid; border-left-width: 6px; }"
                      //progress bar text/background color
                      "QProgressBar   { color: #1e2024; border-color: rgb(255,255,255); border-width: 1px; border-style: solid; }"
                      //progress bar chunk color
                      "QProgressBar::chunk { background: #e09900; }"
